...
vuris="URIs: https://qgis.org/ubuntu"
vsuites="Suites: noble"
...
echo 
echo ------------------------------------------------------------
echo If you don t know informations about the release, try in the terminal
echo to check release info: cat /etc/*rele*
echo to check your distribution name: lsb_release -cs
echo ------------------------------------------------------------
echo
